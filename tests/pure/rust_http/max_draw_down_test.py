...
from pure.finance_utils.draw_down_test import DRAW_DOWN_RESULT_MAPPING
...
@pytest.mark.parametrize(
    ("point_data", "expected_result"), list(DRAW_DOWN_RESULT_MAPPING.items())
)
def test_max_draw_down(point_data, expected_result, rust_endpoint):
